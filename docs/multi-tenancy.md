...
| `plan` | Access tier stored by the code |
...
Organizations have seat limits based on their access tier. The system automatically:

- Tracks `seats_used` when members are added or removed
- Rejects new members when the organization is at capacity
